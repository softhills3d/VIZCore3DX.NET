...
| **VIZCore3DX.NET.GeometryProperty** | 모델의 최소점, 최대점, 중심점, 크기, 부피 등 기하학 속성을 조회하는 예제 |
...
| **VIZCore3DX.NET.SelectByBox_IncludeAssembly** | 박스 선택으로 Part를 선택하고 상위 Assembly까지 포함하여 조회하는 예제 |
