namespace VIZCore3DX.NET.NoteTransform
{
    partial class FrmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "VIZCore3DX.NET.NoteTransform";
